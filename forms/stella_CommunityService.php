<html>
   <head onload="MM_preloadImages('../images/stella.png')"
	  ...
	  <div class="nav">
     <p align="center" class="style1"><span class="tab1"></span><h>Community Service</h></p>
   ...
   <body>
      <form method="post" action="../../php/stella_PeerMentor.php">
		...
		<a>Date of Participation</a><br>
		<label class="magiclabel" for="input-5">xx/xx/2014</label>
		<input class="magiclabel" type="text" name="firstMentor" id="input-5" value=""><br><br>
		
        <a>Start Time</a><br>
		<label class="magiclabel" for="input-6">x:xx</label>
