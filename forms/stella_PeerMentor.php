<html>
   <head onload="MM_preloadImages('../images/stella.png')"
	  ...
	  <div class="nav">
	  <p align="center" class="style1"><span class="tab1"></span><b>Shadow Mentoring<b/></p>
   ...
   <body>
      <form method="post" action="../../php/stella_PeerMentor.php">
		<a>Mentor's Name</a><br>
		<label class="magiclabel" for="input-1">first</label>
		<input class="magiclabel" type="text" name="firstMentor" id="input-1" value=""> 
		<label class="magiclabel" for="input-2">last</label>
		<input class="magiclabel" type="text" name="lastMentor"  id="input-2" value=""><br><br>

		<a>Mentee's Name</a><br>
		<label class="magiclabel" for="input-3">first</label>
		<input class="magiclabel" type="text" name="firstMentor" id="input-3" value=""> 
		<label class="magiclabel" for="input-4">last</label>
		<input class="magiclabel" type="text" name="lastMentor"  id="input-4" value=""><br><br><br><br>
		...
		<input class="magiclabel" type="text" name="firstMentor" id="input-5" value=""> 
		...
		<label>Any Concerns or comments (Please be specific). Please explain all activities you participated in together and where they took place</label>
		<textarea align="left" rows="10" cols="100">
		</textarea><br><br>

		<label>Actions Taken: (Please include who, what, when, and where)</label><br>
		<textarea align="left" rows="10" cols="100">
		</textarea>
		<br>
